...
# 38 "sources/bitmap_inline_asm.c" 1
	btsl %ecx,bitmap@GOTOFF(%ebx,%esi,4)	# bit, *word_7
	setb %al
# 0 "" 2
# sources/bitmap_inline_asm.c:40:     if (!(*word & (1UL << bit))) {
#NO_APP
	movl	bitmap@GOTOFF(%ebx,%esi,4), %esi	# MEM <long unsigned int[2]> [(long unsigned int *)&bitmap][_1], _2
# sources/bitmap_inline_asm.c:40:     if (!(*word & (1UL << bit))) {
	btl	%ecx, %esi	# bit, _2
	jnc	.L5	#,
...
# ${MULTILIB_ROOT}/usr/include/bits/stdio2.h:79:   return __fprintf_chk (__stream, __USE_FORTIFY_LEVEL - 1, __fmt,
	...
	leal	.LC0@GOTOFF(%ebx), %eax	#, tmp101
	pushl	%edx	# n
	.cfi_def_cfa_offset 36
	pushl	%eax	# tmp101
	.cfi_def_cfa_offset 40
# sources/bitmap_inline_asm.c:41:         fprintf(stderr,
	movl	stderr@GOT(%ebx), %eax	#, tmp102
# ${MULTILIB_ROOT}/usr/include/bits/stdio2.h:79:   return __fprintf_chk (__stream, __USE_FORTIFY_LEVEL - 1, __fmt,
	pushl	$2	#
...
# sources/bitmap_inline_asm.c:52:     use_bit(0);
	xorl	%eax, %eax	#
# sources/bitmap_inline_asm.c:49: {
	pushl	-4(%ecx)	#
	pushl	%ebp	#
	movl	%esp, %ebp	#,
